...
export default function ComplianceAnalysis() {
  ...
  const [applyDirectServiceOffsets, setApplyDirectServiceOffsets] = useState(false);
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Compliant Communities</CardTitle>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="bg-gray-50">Municipal/FN Sites</TableHead>
