      ...
      try {
        ...
        if (sitesData && municipalitiesResponse) {
          ...
          const municipalitiesData: Municipality[] =
            municipalitiesResponse.results.map((m) => ({
              id: m.id,
              name: m.name,
          ...
          const complianceResults = await calculateCompliance(
            municipalitiesData,
            sitesData,
          )
          const compliance: ComplianceData = {
            totalSites: sitesData.length,
            compliantMunicipalities: complianceResults.filter(
              (r) => r.status === 'compliant',
            ).length,
            totalMunicipalities: municipalitiesData.length,
            shortfalls: complianceResults.reduce(
